...
function listUserMsg(userMsg,hospitalName,dietAdvice,doctorAdvice,addTime,reportNumber){
	...
	$("#bodyFatRate").text((userMsg.bodyFatRate==0 || userMsg.bodyFatRate== "")?"/":userMsg.bodyFatRate+"%");
	$("#muscle").text((userMsg.muscle==0 || userMsg.muscle=="")?"/":userMsg.muscle+"%");
	$("#moistureContent").text((userMsg.moistureContent==0 || userMsg.moistureContent=="")?"/":userMsg.moistureContent+"%");
	$("#basalMetabolism").text((userMsg.basalMetabolism==0 || userMsg.basalMetabolism=="")?"/":userMsg.basalMetabolism+"kcal");
