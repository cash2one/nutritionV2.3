...
public class VoWeightChart {
	...
	/** 用户HIS体重列表的集合Object[0]横坐标怀孕天数，Object[1]体重值 */
	private List<Object[]> hisWeightList = new ArrayList<Object[]>();
	/** 预产期 */
	...
	public List<Object[]> getHisWeightList() {
		return hisWeightList;
	}
	public void setHisWeightList(List<Object[]> hisWeightList) {
		this.hisWeightList = hisWeightList;
	}
