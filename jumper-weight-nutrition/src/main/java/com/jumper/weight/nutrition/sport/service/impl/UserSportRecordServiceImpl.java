...
public class UserSportRecordServiceImpl extends BaseServiceImpl<UserSportRecord> implements UserSportRecordService {
	...
	@Override
	public boolean addSportRecordByDate(int hospitalId, int userId, String date, List<VoUserSportRecord> voList) {
		...
		//用户最近的一条体重记录
		Double currWeight = userWeightRecordService.findLastWeight(hospitalId, userId);
		//查询运动集合
