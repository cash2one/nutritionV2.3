...
public interface UserWeightRecordService extends BaseService<UserWeightRecord> {
	...
	/**
	 * 保存某天的体重记录
	 * @createTime 2017年9月4日,上午11:54:57
	 * @createAuthor fangxilin
	 * @param weight
	 * @param date
	 * @param userId
	 ...
	 * @return
	 */
	boolean saveWeightByDate(Double weight, Date date, int userId, int hospitalId);
	
	/**
	 * 查询用户最近的一条体重，如果没有返回孕前体重
	 * @createTime 2017年9月8日,下午2:17:59
	 * @createAuthor fangxilin
	 * @param hospitalId
	 * @param userId
	 * @return
	 */
	Double findLastWeight(int hospitalId, int userId);
}
