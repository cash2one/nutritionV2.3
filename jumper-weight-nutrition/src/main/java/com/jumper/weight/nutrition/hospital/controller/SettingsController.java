...
public class SettingsController extends BaseController {
	...
	public void getQRCode(HttpServletResponse response,
       ...
       /* String baseUrl=Consts.BASE_PATH + "/mobile/checkPage.html";
        ...
        if(isHis == 1){
        	content = Consts.BASE_PATH + "/mobile/bafy/login.html?hospitalId=" + hospitalId;
        }
        logger.debug(content);
...
//        String content = Consts.USER_PORTAL_URL + "?owneId=0&hospitalId=" + hospitalId + "&url=" + encodeUrl;
	...
	@ApiOperation(value = "获取医院就诊原因", httpMethod = "POST", response = ReturnMsg.class, notes = "获取医院就诊原因", position = 3)
	...
	@ApiOperation(value = "保存医院就诊原因", httpMethod = "POST", response = ReturnMsg.class, notes = "保存医院就诊原因", position = 4)
	...
	@ApiOperation(value = "根据就诊原因ID获取医院就诊原因", httpMethod = "POST", response = ReturnMsg.class, notes = "根据就诊原因ID获取医院就诊原因", position = 3)
